...
import { NgxExtendedPdfViewerModule, PageViewModeType, PdfLoadedEvent, ProgressBarEvent, VerbosityLevel } from 'ngx-extended-pdf-viewer';
import { CommonModule } from '@angular/common';
import { PageViewMode } from '@rapider/angular-components/core/pdf-viewer';
